 ...
 MyCylinder.prototype.initBuffers = function() {
	...
	for(i = 0; i < this.stacks; i++){
		for(j = 0; j < this.slices; j++){
			...
			this.indices.push(this.slices + this.slices*i + this.slices + j,this.slices + this.slices*i + 1 + j,this.slices + this.slices*i + j);
			this.indices.push(this.slices + this.slices*i + 1 + j,this.slices + this.slices*i + this.slices + j,this.slices + this.slices*i + this.slices + 1 + j);
